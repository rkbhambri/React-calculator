...
const CalculatorButtons = (props) => {
    return (
        <div className="buttons-wrapper">
            <Button onClick={(event) => props.handleClick(event)} label="C" value="clear" />
            ...
            <Button onClick={(event) => props.handleClick(event)} label="6sdsd" value="6sd" />
            <Button onClick={(event) => props.handleClick(event)} label="0" value="0" />
            <Button onClick={(event) => props.handleClick(event)} label="." value="." />
            <Button onClick={(event) => props.handleClick(event)} label="s" value="s" />
            <Button onClick={(event) => props.handleClick(event)} label="=" value="=" />
